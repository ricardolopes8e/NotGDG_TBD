(function(a) {
    a(document).ready(function() {
        ...
        a(function() {
            ...
            c = 0;
            for (e = f.length; c < e; c++) d = f[c], b = d.offsetLeft + d.offsetTop, b /= 1E3, a(d).css("transition-delay", "" + .47 * b + "s"), a(d).css("transition-duration", "0.2s")
        });
        ...
        a(".animated").appear(function() {
            ...
            }, c) : (b.addClass(d + " visible"), b.removeClass("hiding"), b.hasClass("counter") && b.find(".timer").countTo())
        }, { accY: -150 });
        ...
        google.maps.event.addDomListener(window, "load", function() {
            ...
            function v(a) {
                var b = c.getZoom(),
                    d = Math.abs(a - b),
                    e = a > b ? 1 : -1;
                for (a = 0; a < d; a++) setTimeout(function() {
                    b += e;
                    c.setZoom(b)
                }, 50 * (a + 1))
            }
            ...
            "venue" == googleMaps && (f.zoom = 5, f.zoomControl = !0);
            ...
            "venue" === googleMaps ? (c.setMapTypeId("default"), f = document.getElementById("location-input"), q = new google.maps.places.Autocomplete(f), google.maps.event.addListener(q, "place_changed", function() {
                t.setVisible(!1);
                var a = q.getPlace();
